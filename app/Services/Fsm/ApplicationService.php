...
class ApplicationService
{
    ...
    public function export(Request $request)
    {
        ...
        // dd($emptying_status, $feedback_status, $sludge_collection_status);
        ...
        } elseif (Auth::user()->hasRole('Treatment Plant')) {
    ...
    public function fethMonthlyReport($year, $month)
    {
        ...
        */
        public function getApplicationReport($id){
            ...
            $containment = DB::table('fsm.applications as a')
            ->leftJoin('building_info.buildings as b', 'b.bin', '=', 'a.bin')
            ->leftJoin('building_info.build_contains as bc', 'bc.bin', '=', 'b.bin')
            ->leftJoin('fsm.containments as c', 'bc.containment_id', '=', 'c.id')
