    ...
    public function getAllData($data)
    {
        ...
        return Datatables::of($TreatmentPlantEffectiveness)
            ...
            ->addColumn('action', function ($model) {
                ...
                if (Auth::user()->can('View Treatment Plant Effectiveness')) {
                 ...
                 if (Auth::user()->can('Edit Treatment Plant Effectiveness')) {
                ...
                if (Auth::user()->can('Delete Treatment Plant Effectiveness')) {
