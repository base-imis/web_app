...
<div class="card" style="font-family: 'Open Sans', sans-serif;">
    <div class="card-header">
        <a class="btn btn-info float-right" id="toggleFilter" type="button" data-toggle="collapse" data-target="#filterSection" aria-expanded="true" aria-controls="filterSection">
            Show Filter
        </a>
    </div><!-- /.card-header -->
    <div class="card-body">
