...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar" style='overflow-y: scroll; font-family: Open Sans, sans-serif'>
        <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ request()->is('building-info/*','layer-info/low-income-communities/*') ? 'menu-is-opening menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ action('LayerInfo\LowIncomeCommunityController@index') }}" class="nav-link {{ request()->is('building-info/low-income-communities') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
            ...
            @if (auth()->user()->can('List SWM Service Payment Collection'))
            <li class="nav-item">
                ...
                {{--
                    {{-- <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('swm-payment.index') }}" class="nav-link">
            ...
            <li class="nav-item {{ request()->is('fsm/hotspots/*','fsm/hotspots', 'publichealth/waterborne/*','publichealth/waterborne','publichealth/water-samples/*','publichealth/water-samples') ? 'menu-is-opening menu-open' : '' }}">
                <a href="#" class="nav-link {{ request()->is('fsm/hotspots/*','fsm/hotspots','publichealth/waterborne/*','publichealth/waterborne' ,'publichealth/water-samples/*','publichealth/water-samples') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ action('Fsm\HotspotController@index') }}" class="nav-link {{ request()->is('fsm/hotspots/*','fsm/hotspots') ? 'active' : '' }}">
                    <i class="far fa-circle nav-icon"></i>
