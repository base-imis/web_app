    ...
    <main id="main">
         ...
         <section id="about" class="about section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="text-left">
                <p>
The Integrated Municipal Information System (IMIS) is a comprehensive digital platform that seamlessly merges web, mobile, and GIS technologies, leveraging open-source software platforms. This innovative system offers a comprehensive solution for managing the entirety of a city's information. IMIS stands as a holistic solution designed to manage the complete information of a city, empowering local governments in the planning, management, and monitoring & evaluation of sanitation systems and services with the aim of achieving SDG 6.2 through the Citywide Inclusive Sanitation (CWIS) approach.</p> </br>
<p>IMIS achieves this by integrating diverse municipal functions and data, enabling real-time reporting, fostering transparency and accountability, and facilitating the monitoring of key performance indicators. The system facilitates informed decision-making processes, ensuring efficient service delivery and optimal resource allocation for the betterment of the community.
</p>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                        ...
                        <img src="{{ asset('img/svg/landing-page/ptctIMS.svg')}}" class="icon" alt="PTCT  Icon">
                                ...
                                <div class="card-body">
                                    <!--Title-->
                                    <h5 class=" text-center ">Community/ Public Toilet (CT/PT) Information Management System</h5>
                                    <!--Text-->
                                    <div class="card-text text-left ">
                                        <ul>
                                            <li>
