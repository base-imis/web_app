    ...
    <div class="form-horizontal">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    {!! Form::label(($userDetail->gender=='Male')?"Male":(($userDetail->gender=='Female')?"Female":"-"),null,['class' => 'form-control']) !!}
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    {!! Form::label(implode(', ', $userRoles),null,['class' => 'form-control', 'style' => 'min-height:200px;']) !!}
                </div>
            </div>
            {{--<div class="form-group row">
