...
<div class="card-body">
    <div class="form-group required row">
        ...
        <div class="col-sm-3">
            {!! Form::text('hotspot_location',null,['class' => 'form-control', 'placeholder' => 'Hotspot Location']) !!}
        </div>
    </div>
    <div class="form-group required row">
        {!! Form::label('date','Date',['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-3">
            {!! Form::date('date',null,['class' => 'form-control date', 'placeholder' => 'Date','autocomplete' => 'off', 'id'=>'date']) !!}
        </div>
    </div>
    ...
    <div class="form-group  row">
        ...
        <div class="col-sm-3">
            {!! Form::number('male_cases',null,['class' => 'form-control', 'placeholder' => ' Male']) !!}
        </div>
    </div>
    ...
    <div class="form-group  row">
        ...
        <div class="col-sm-3">
            {!! Form::number('female_cases',null,['class' => 'form-control', 'placeholder' => 'Female']) !!}
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            {!! Form::number('other_cases',null,['class' => 'form-control', 'placeholder' => 'Other']) !!}
        </div>
    </div>
    ...
    <div class="form-group  row">
        ...
        <div class="col-sm-3">
            {!! Form::number('male_fatalities',null,['class' => 'form-control', 'placeholder' => 'Male']) !!}
        </div>
    </div>
    <div class="form-group  row">
        {!! Form::label('female_fatalities','Female',['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-3">
            {!! Form::number('female_fatalities',null,['class' => 'form-control', 'placeholder' => 'Female']) !!}
        </div>
    </div>
    ...
    <div class="form-group  row">
        ...
        <div class="col-sm-3">
            {!! Form::number('other_fatalities',null,['class' => 'form-control', 'placeholder' => 'Other']) !!}
        </div>
    </div>
...
<div class="card-footer">
    <a href="{{ action('Fsm\HotspotController@index') }}" class="btn btn-info">Back to List</a>
