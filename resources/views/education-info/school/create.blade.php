...
<div class="card card-info">
    ...
    <div class="card-body" style="font-family: 'Open Sans', sans-serif;">
            ...
            <div class="col-sm-5">
                @foreach ($studentLevels as $levelKey => $level)
                    <div class="form-check">
                        {!! Form::checkbox($level['checkbox'], 1, false, [
                ...
                <div class="col-sm-5">
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            {!! Form::number($level['fields']['girls'], 0, ['class' => 'form-control student-count', 'min' => 0, 'placeholder' => 'Female']) !!}
                        </div>
                        <div class="form-group col-md-3">
                            {!! Form::label($level['fields']['boys'], 'Male') !!}
                            {!! Form::number($level['fields']['boys'], 0, ['class' => 'form-control student-count', 'min' => 0, 'placeholder' => 'Male']) !!}
                        </div>
                        <div class="form-group col-md-3">
                            {!! Form::label($level['fields']['other'], 'Other') !!}
                            {!! Form::number($level['fields']['other'], 0, ['class' => 'form-control student-count', 'min' => 0, 'placeholder' => 'Other']) !!}
                        </div>
                        <div class="form-group col-md-3">
                            {!! Form::label($level['fields']['total'], 'Total') !!}
                            {!! Form::number($level['fields']['total'], 0, ['class' => 'form-control row-total student-level-total', 'min' => 0, 'placeholder' => 'Total', 'readonly' => true]) !!}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-5">
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        {!! Form::number('total_girls', 0, ['class' => 'form-control', 'min' => 0, 'placeholder' => 'Total Female', 'readonly' => true]) !!}
                    </div>
                    <div class="form-group col-md-3">
                        {!! Form::label('total_boys', 'Male') !!}
                        {!! Form::number('total_boys', 0, ['class' => 'form-control', 'min' => 0, 'placeholder' => 'Total Male', 'readonly' => true]) !!}
                    </div>
                    <div class="form-group col-md-3">
                        {!! Form::label('total_other', 'Other') !!}
                        {!! Form::number('total_other', 0, ['class' => 'form-control', 'min' => 0, 'placeholder' => 'Total Other', 'readonly' => true]) !!}
                    </div>
                    <div class="form-group col-md-3">
                        {!! Form::label('total_students', 'Total') !!}
                        {!! Form::number('total_students', 0, ['class' => 'form-control', 'min' => 0, 'placeholder' => 'Grand Total', 'readonly' => true]) !!}
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-5">
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        {!! Form::number('teachers_male', 0, ['class' => 'form-control teacher-count', 'min' => 0]) !!}
                    </div>
                    <div class="form-group col-md-3">
                        {!! Form::label('teachers_female', 'Female') !!}
                        {!! Form::number('teachers_female', 0, ['class' => 'form-control teacher-count', 'min' => 0]) !!}
                    </div>
                    <div class="form-group col-md-3">
                        {!! Form::label('teachers_other', 'Other') !!}
                        {!! Form::number('teachers_other', 0, ['class' => 'form-control teacher-count', 'min' => 0]) !!}
                    </div>
                    <div class="form-group col-md-3">
                        {!! Form::label('teachers_total', 'Total') !!}
                        {!! Form::number('teachers_total', 0, ['class' => 'form-control', 'min' => 0, 'readonly' => true]) !!}
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-sm-5">
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::number($row['fields']['male'], 0, ['class' => 'form-control facility-count', 'min' => 0, 'placeholder' => 'Male']) !!}
                            </div>
                            <div class="form-group col-md-3">
                                {!! Form::label($row['fields']['female'], 'Female') !!}
                                {!! Form::number($row['fields']['female'], 0, ['class' => 'form-control facility-count', 'min' => 0, 'placeholder' => 'Female']) !!}
                            </div>
                            <div class="form-group col-md-3">
                                {!! Form::label($row['fields']['other'], 'Other') !!}
                                {!! Form::number($row['fields']['other'], 0, ['class' => 'form-control facility-count', 'min' => 0, 'placeholder' => 'Other']) !!}
                            </div>
                            <div class="form-group col-md-3">
                                {!! Form::label($row['fields']['total'], 'Total') !!}
                                {!! Form::number($row['fields']['total'], 0, ['class' => 'form-control row-total', 'min' => 0, 'placeholder' => 'Total', 'readonly' => true]) !!}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                {!! Form::number('universal_design_toilet_count', 0, ['class' => 'form-control col-sm-10', 'min' => 0, 'placeholder' => 'Number of Universal Design Toilets']) !!}
            </div>
        </div>
    ...
    <div class="card-footer">
        ...
        {!! Form::submit('Save', ['class' => 'btn btn-info prevent-multiple-submits']) !!}
    </div>
    {!! Form::close() !!}
</div>
@stop
