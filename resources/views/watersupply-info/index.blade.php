...
<div class="card">
    ...
    @can('Import Water Supply Payment Info From CSV')
        ...
        <a href="/templates/water-supply-template-iss.csv" download="Water Supply Information Support System-template.csv" class="btn btn-info">Download CSV Template</a>
        @endcan
        @can('Export Water Supply Info')
