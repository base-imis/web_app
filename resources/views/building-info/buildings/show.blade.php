    ...
    <div class="card card-info">
        <div class="card-header bg-transparent">
            ...
            <a href="{{ action('BuildingInfo\BuildingController@index') }}"
                class="btn btn-info ">{{ __('Back to List') }}</a>
        </div>
        ...
        'readonly' => 'readonly',
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    {!! Form::text(
        'toilet_status',
        $building->toilet_status === 1 ? 'Yes' :
        ($building->toilet_status === 0 ? 'No' : null),
        [
            'class' => 'form-control col-sm-10 font-weight-bold',
            'readonly' => 'readonly',
        ]
        ...
        ['class' => 'col-sm-2 control-label']
                ...
                <div class="col-sm-3">
                    <a href="{{ $imageSrc ?: '#' }}" target="_blank">
                        <button type="button" class="btn btn-info" {{ $imageSrc ? '' : 'disabled' }}>
